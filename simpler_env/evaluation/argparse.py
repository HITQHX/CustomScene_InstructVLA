...
def get_args():
    ...
    parser.add_argument("--internvla-repo-path", type=str, default=None)
    parser.add_argument("--internvla-unnorm-key", type=str, default=None)
    parser.add_argument("--internvla-cfg-scale", type=float, default=1.5)
    parser.add_argument("--internvla-disable-ddim", action="store_true")
    parser.add_argument("--internvla-num-ddim-steps", type=int, default=10)
    parser.add_argument("--internvla-action-ensemble-horizon", type=int, default=None)
    parser.add_argument("--internvla-adaptive-ensemble-alpha", type=float, default=0.1)
    parser.add_argument("--internvla-image-size", type=int, nargs=2, default=[224, 224])
    parser.add_argument("--internvla-no-bf16", action="store_true")
